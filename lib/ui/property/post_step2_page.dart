...
import 'package:just_appartment_live/ui/dashboard/widgets/dropdown_style_helper.dart';
import 'package:just_appartment_live/ui/property/post_step3_page.dart';
import 'package:just_appartment_live/ui/property/price_input_formatter.dart';
import 'package:just_appartment_live/ui/property/widgets/custom_widget.dart';
            ...
            Visibility(
              ...
              child: Padding(
                ...
                child: CustomDropdownSearch(
                  ...
                  selectedItem: landMeasurementIndex != null
                  ...
                  // Validator is optional since it's optional field
                  validator: (value) {
                    // Add validator logic here if needed
                    return null;
                  },
                  compareFn: (item, selectedItem) =>
                      selectedItem != null && item["id"] == selectedItem["id"],
